...
bool geoGround::attach(RpcServer &source)
{
...
**************************************************/
    ...
    yInfo("rules created");
/**************************************************
// get Affordances probabilities ------------------ THIS FUNCTION NEEDS TO BE CHANGED WHEN I CHANGED AFFORDANCE COMMUNICATION TO RPC
**************************************************/
    if (affordancePort.getOutputCount() == 0)
    {
        yError("Affordances module not connected");
        return "failed_affordances";
    }
